...
import 'package:livraison_front/models/livraison.dart';
...
class PdfInvoiceApi {
  ...
  static Widget buildCustomerAddress(Client customer) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(customer.nom, style: TextStyle(fontWeight: FontWeight.bold)),
      Text(customer.clientAdresse),
    ],
  );
  ...
  static Widget buildSupplierAddress(Livreur supplier) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(supplier.nom, style: TextStyle(fontWeight: FontWeight.bold)),
      SizedBox(height: 1 * PdfPageFormat.mm),
      Text(supplier.livAdresse),
    ],
  );
