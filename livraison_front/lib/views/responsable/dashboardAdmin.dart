...
class DashboardAdmin extends StatefulWidget {
  DashboardAdmin(this.image,this.nom,this.email);
  final String?  image;
  final String?  nom;
  final String?  email;
...
class _DashboardAdmin extends State<DashboardAdmin> with SingleTickerProviderStateMixin  {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: ResponsableService().getStats(),
