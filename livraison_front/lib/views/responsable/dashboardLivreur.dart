...
class DashboardLivreur extends StatefulWidget {
  DashboardLivreur(this.id,this.image,this.nom,this.email);
  final String?  image;
  final String?  id;
  final String?  nom;
  final String?  email;
  ...
  @override
  _DashboardLivreur createState() => _DashboardLivreur();
}

class _DashboardLivreur extends State<DashboardLivreur> with SingleTickerProviderStateMixin  {
