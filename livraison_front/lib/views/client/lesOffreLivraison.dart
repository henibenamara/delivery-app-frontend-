                                                ...
                                                if ((snapshot.hasData)) {
                                                  return ListView.builder(
                                                    itemBuilder: (context, index) {
                                                      return ListTile(
                                                          title: Text(
                                                              "nom Livreur :",style:TextStyle(fontSize: 20),),

                                                          trailing: Text(snapshot.data![index]['nom'],style:TextStyle(fontSize: 20),),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(children: <Widget>[
                                          Text(
                                            "Prix :" +
                                                snapshot.data![index][
                                                'prix'] //(snapshot.data![index]['etatLivraison'].toString()=="en cours")
                                                    .toString()+" DT",
                                            style: const TextStyle(
                                                fontSize: 20.0, color: Colors.white),
                                          ),
                                          ...
                                          FloatingActionButton(
                                            onPressed: () async {
                                              String? prix =snapshot.data![index]['prix'];
                                              String? idliv =widget.livraison.idLivreur.toString();
