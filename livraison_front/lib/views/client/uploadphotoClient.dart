...
class uploadphotoClient extends StatefulWidget {
  uploadphotoClient(this.id);
  final String id;

  @override
  _uploadphotoClient createState() => _uploadphotoClient();
}

class _uploadphotoClient extends State<uploadphotoClient> {
  _uploadphotoClient();
  String? sId;
