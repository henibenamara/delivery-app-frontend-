...
class DetailLivraisonConfirmer extends StatefulWidget {
  ...
  @override
  _DetailLivraisonConfirmerState createState() => _DetailLivraisonConfirmerState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          SizedBox(height: 20),
          Text("Choisir la methode de payement :",textAlign: TextAlign.center,style: TextStyle(fontSize: 20)),
          SizedBox(height: 20),
          Row(
